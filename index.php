...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Appro - Landing Page Template</title>
    ...
    <body>
        ...
        <div class="wrapper">
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 col-md-3"> 
                                <div class="single-item res-sm text-center">
                                    ...
                                    <h3 class="ht-pt">Easy To Customize</h3>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="single-item res-sm res-xs text-center">
                                    ...
                                    <h3 class="ht-pt">User Friendly</h3>
                                    <p>There are many variati passages of Lorem Ipsum availat majority have suffered aou need</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="single-item text-center">
                                    ...
                                    <h3 class="ht-pt">modern Design</h3>
                                    <p>There are many variati passages of Lorem Ipsum availat majority have suffered aou need</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="video-img-icon">
                                <div class="about-bottom-img">
                                    <img src="Styles/img\video\2.jpg" alt="">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="about-bottom-left clearfix">
                                ...
                                <p class="about-pb">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even sli believable Section ve suffered alteration</p>
                                <p>The standard chunk of Lorem Ipsum used since the 1500s ioduced below for those interested. </p>
            ...
            <!-- Funfact Area Start -->
            <section class="funfact-area clearfix gray-bg pt-100 pb-70">
                <div class="container">
                    <div class="row">
                ...
                <div class="col-md-6 col-sm-6 p-0 col-md-push-6 col-sm-push-6">
                    <div class="screenshot-slider">
                        <div class="single-screenshot">
                            <div class="image">
                                <a class="venobox" href="Styles/img\screenshort\1.jpg"><img src="Styles/img\screenshort\1.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="single-screenshot">
                            <div class="image">
                                <a class="venobox" href="Styles/img\screenshort\2.jpg"><img src="Styles/img\screenshort\2.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="single-screenshot">
                            <div class="image">
                                <a class="venobox" href="Styles/img\screenshort\1.jpg"><img src="Styles/img\screenshort\3.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="single-screenshot">
                            <div class="image">
                                <a class="venobox" href="Styles/img\screenshort\2.jpg"><img src="Styles/img\screenshort\4.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="single-screenshot">
                            <div class="image">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-6 pr-0 awesome-desc">
                                <div class="about-bottom-left">
                                    ...
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, binjected humour passages of Lorem.</p>
                                </div>
                            </div>
                        </div>
                    </div>			
                            ...
                            <div class="slider-2">
                                <div class="single-team text-center">
                                    <div class="team-image">
                                        <img src="Styles/img\testimonial\1.png" alt="">
                                    </div>
                                    <div class="team-details mt-20">
                                        <h2>Shakara Tasnim</h2>
                                        ...
                                        <div class="team-social fix">
                                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolorentium, totam rem <br>aperiam, eaque ipsa quae ab illo inventore veritatis et i architecto beatae vitae dicta sunt explicabo.<br>Nemo enim sit se cena hoye keno </p>
                                        </div>
                                        <div class="test-icon">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-img-text res">
                                <div class="blog-img">
                                    <a href="#"><img src="Styles/img\blog\1.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="blog-img-text">
                                <div class="blog-img">
                                    <a href="#"><img src="Styles/img\blog\2.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <span>15 May 2016</span>
                                    <h4><a href="#">There are many variations of passa Lorem.</a></h4>
                    ...
                    <div class="row">          
                        <div class="item_all indicator-style3">
                            <div class="col-md-12 single-item2">
                                <a href="#"><img src="Styles/img\logo-slider\2.png" alt=""></a>
                            </div>
                            <div class="col-md-12 single-item2">
                                <a href="#"><img src="Styles/img\logo-slider\3.png" alt=""></a>
                            </div>
                            <div class="col-md-12 single-item2">
                                <a href="#"><img src="Styles/img\logo-slider\4.png" alt=""></a>
                            </div>
                            <div class="col-md-12 single-item2">
                                <a href="#"><img src="Styles/img\logo-slider\5.png" alt=""></a>
                            </div>
                            <div class="col-md-12 single-item2">
                                <a href="#"><img src="Styles/img\logo-slider\2.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-md-12 text-center">
                        <div class="footer-all">
                            ...
                            <div class="footer-text">
                                <span>
                                    Copyright©
                                    <a href="http://bootexperts.com/" target="_blank">APPRO</a>
